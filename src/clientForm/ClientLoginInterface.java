            ...
            if(loginButton.isEnabled()) {
                try {
                    ...
                    if(cpf.equalsIgnoreCase("") || password.equalsIgnoreCase("")) {
                        ...
                        System.out.println("JSON to server: " + gson.toJson(person));

                        in = new BufferedReader(new InputStreamReader(clientSocket.getInputStream()));
                        String serverResponse = in.readLine(); //get the response from server
                        person = gson.fromJson(serverResponse, Person.class);
                        System.out.println("JSON from server: " + gson.toJson(person));

                        if (person.getStatus() == true) { //check the server response
